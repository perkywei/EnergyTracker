...
async function loadCodes() {
    try {
        const res = await fetch(`${API_BASE}/admin/codes?adminToken=${encodeURIComponent(getAdminToken())}`);
...
async function loadUsers() {
    try {
        const res = await fetch(`${API_BASE}/admin/users?adminToken=${encodeURIComponent(getAdminToken())}`);
